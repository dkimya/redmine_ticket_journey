module TicketJourneyHelper
  def d_fields
    ...
    { key: :D5,    label: 'D5',     aug: false, desc: 'QA pass wait gap' },
    { key: :D5aug, label: 'D5-aug', aug: true,  desc: 'Code Review duration' },
    { key: :D6,    label: 'D6',     aug: false, desc: 'Review pass wait gap' },
